...
Particular focus was placed on the effect of chiral strength between the rods which drives the formation of twiated structures, analogaous to the classical choelsteric liquic srystak in bulk. However, strong  side-by-side attractions between rods mediated by the depletion forces constrains the rods into quasi-2d circular membranes with a double-twisted 

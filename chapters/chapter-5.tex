...
\beq
\frac{F}{K_{2}} \sim   -q q_{0} +   \frac{q_{0}^{2}}{2}    +  \left ( \frac{\Delta K}{4} + \frac{L^{2}}{16\lambda_{t}^{2}}\right )  q^{2} + \frac{2 L }{\pi \lambda_{t}^{2}}
\label{flowq}
\eeq
The first two terms encode the free energy change due to (chiral) twist, the third denotes the effect of splay, bend and saddle-splay elasticity along with depletion, whereas the term denotes the line tension which up to leading order does not depend on the pitch.  The constant $\Delta K$ represents a combination of the  bend-twist and saddle-twist elastic anisotropies:
\beq

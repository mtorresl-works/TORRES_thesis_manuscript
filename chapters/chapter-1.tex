...
\red{Here I would briefly mention that a more complete LC continuum theory, the famous Landau De Gennes or Q-tensor theory (we may refer to book of De Gennes and Prost for details),  in principle does account for changes in the bulk nematic order, but that we do not use this framework in our thesis. Again, this is basically Jason's numerical simulations in Chapter 3. In our analytical work in Chapter. 3-5 we apply nemato-elastic theory assuming that the bulk nematic order is uniform (as in thew bulk) and not affected by spatial variations of the director field. This often makes theory analytically tractable. Note that we also apply Eq. 1.27 for our ribbon and membrane theories !  } 

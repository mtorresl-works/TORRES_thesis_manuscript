...
The Frank elastic energy is often simplified by assuming the {\em one constant approximation}: $K_1=K_2=K_3$, in which case \eq{frankoseen} reduces to:

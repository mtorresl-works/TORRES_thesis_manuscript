...
The interaction between two particles only contributes to the integral in Eq. \ref{B2} if particles are close enough to overlap, i. e. if they are both contained inside the {\em excluded volume} generated from their relative orientations:
...
The excluded volume for a pair of spherocylinders as sketched in Fig. \ref{introfig3} reads

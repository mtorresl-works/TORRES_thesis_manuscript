...
\begin{figure}
\centering{\includegraphics[width=12cm]{introliqcryst}}
...
\begin{figure}
\centering{\includegraphics[width=16cm]{intro1}}
...
%\begin{equation}
%c(\vq;\Omega,\Omega^{\prime})=\tilde{f}_{\text{CS}}(\phi)\int_{\partial v_{\text{excl}}(\Omega,\Omega^{\prime})}
%d\bfr\cos(\vq \cdot \bfr), 
%\begin{equation}
